...
> **最近一次更新**：2026-09-21，拓扑调整——确认 **133 与 245 之间没有
> UB 总线连接**（133↔245 URMA 通信本就不可能通，驱动换装方案作废，245 退出）。
> 计划回归 **197+151** 拓扑（该链路 URMA 已验证可通），当前状态：**先执行
> 批次 R-0（197 可用性侦察，只读）**，确认后外部再下发回归执行批 R-1。
> 环境详情以 R-1 下发时的更新为准，历史参数见任务书 2026-09-15~17 各回执。
